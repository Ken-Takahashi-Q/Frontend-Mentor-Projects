...
// const errorMessageEl = nameInp.parentElement.querySelector(".error-message");

// const num = /\d/;
// const nameHaveNum = num.test(nameInp.value);
...
function handleSubmit(e) {
    ...
    //     nameInp.classList.add("error");
    //     nameInp.parentElement.classList.add("error_message");
    //     nameInp.parentElement.innerHTML = "Wrong type";
